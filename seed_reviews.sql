-- Seed Reviews Data
-- We verify against product slugs from products.ts
-- Products: 
-- moringa-hair-care-gift-set
-- moringa-reishi-hair-serum
-- moringa-keratin-conditioner
-- moringa-anti-hairfall-shampoo
...
-- 1. Moringa Hair Care Gift Set (p1)
...
-- 2. Moringa & Reishi Hair Serum (p2)
...
-- 3. Moringa & Keratin Conditioner (p3)
